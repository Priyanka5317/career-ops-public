> **This is a redistributed copy, not the canonical repository.**
> `career-ops` is an MIT-licensed project by Santiago Fernandez de Valderrama.
> The canonical upstream is <https://github.com/santifer/career-ops> -- file
> issues and get the latest version there, not here. This copy is a
> point-in-time snapshot with all personal job-search data removed, and it is
> not affiliated with or endorsed by the upstream maintainer. See
> [NOTICE.md](NOTICE.md) for exactly what was changed.
